...
export const _userAbout = {
  ...
  role: 'Designer',
  aniversario: '1 año 3 meses como',
  telefono: '5579218374',
  ...
  nacimiento:'15 noviembre 1964',
  area: 'Desarrollo',
  antiguedad:'1 año',
  colaborador:'140',
  ingreso:'15 de diciembre 2021',
...
export const _departamentoList = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
...
export const _eventList = [...Array(12)].map((_, index) => ({
  id: _mock.id(index),
  name: randomInArray(['Rogafin', 'SOC', 'Banamex','Integra','TOI','AFIRME','Ve Por Mas','RHHR','Sometra', 'Persona Fisica','Broker Moral temporal','Broker Fisico Completo']),      // _mock.name.fullName(index),
  email: _mock.email(index),
}));

export function ReturnSome() {
    return ("Este es el correo")
}
