...
import { END_POINT_BANDEJA_PUESTO, END_POINT_BANDEJAEMPLEADOS_EMPRESA, END_POINT_BANDEJA_DEPARTMENTO_EMPLEADO } from '../../config-global';
import GenericDataGridCustom from '../../sections/_examples/mui/data-grid/GenericDataGridCostom';


BandejaDepartamentoEmpleado.propTypes = {
    departamentoId: PropTypes.any,
};

export default function BandejaDepartamentoEmpleado({ departamentoId }) {
    ...
    const parametroGenerico = `#Departamento#${departamentoId}`
                        ...
                        <AccordionDetails>
                            <TableContainer sx={{ position: 'relative', overflow: 'unset' }}>
                                {perfilUsuario === 'RecursosHumanos' ? (
                                    <GenericDataGridCustom EndPoint={END_POINT_BANDEJA_DEPARTMENTO_EMPLEADO} columns={columnsEmpleado} genericParamAUX={parametroGenerico} />
                                ) :
