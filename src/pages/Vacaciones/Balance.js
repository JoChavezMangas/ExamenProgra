            ...
            {arrayEmpelados.map((item) => (
                <Grid item xs={12} md={4}>
                    <TarjetaBalance
                        ...
                        FechaIngresoString={item.fechaIngresoString}
                    />
                </Grid>
            ))}
            </>
...
TarjetaBalance.prototype = {
    ...
    FechaIngresoString: PropTypes.string
};

function TarjetaBalance({ Nombre, VacacionesTotal, VacacionesActuales, VacacionesAnteriores, Personales, Puesto, EmpleadoId, FechaIngresoString }) {
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item md={10}>
                        ...
                        <Box sx={{ display: 'flex' }}>
                            ...
                            <Typography variant='body2'>&nbsp; {FechaIngresoString}</Typography>
                        </Box>
