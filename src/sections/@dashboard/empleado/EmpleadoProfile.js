...
EmpleadoProfile.propTypes = {
  isEdit: PropTypes.bool,
  currentEmpleado: PropTypes.object,
};


export default function EmpleadoProfile({ isEdit = false, currentEmpleado }) {
  ...
  const NewEmpleadoSchema = Yup.object().shape({
    ...
    segundoNombre: Yup
      ...
      .min(1, "Debes ingresar como mínimo 2 caracteres").max(20)
      .matches(/^[aA-zZ\s]+$/, "Sólo letras"),
        ...
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h6' color='primary' sx={{ pb: 3 }}>Datos personales</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
            ...
            >
              ...
              <GenericCombo
                ...
                valorDefault={empresaValor}
              />
              <RHFTextField disabled={disabled} name="ine" label="INE" />
              <RHFTextField disabled={disabled} name="curp" label="CURP" />
              <RHFTextField disabled={disabled} name="pasaporte" label="Pasaporte" />
      ...
      <Grid container spacing={3} sx={{ pb: 3 }}>
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h5' color='primary' sx={{ pb: 3 }}>Direcciones</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
            ...
            <Box
            >
              <RHFTextField disabled={disabled} name="direccion" fullWidth label="Dirección" />
            </Box>
          </Card>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={3} sx={{ pb: 3 }}>
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h5' color='primary' sx={{ pb: 3 }}>Datos laborales</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
      ...
      <Grid container spacing={3} sx={{ pb: 3 }}>
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h5' color='primary' sx={{ pb: 3 }}>Datos bancarios</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
      ...
      <Grid container spacing={3} sx={{ pb: 3 }}>
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h5' color='primary' sx={{ pb: 3 }}>Datos de nómina</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
            ...
            >
              <RHFTextField disabled={disabled} name="sueldoDiario" label="Sueldo Diario" onKeyPress={(e) => handleKeyPressNumber(e)}/>
              <RHFTextField disabled={disabled} name="sueldoDiarioIntegrado" label="Sueldo Diario Integrado" onKeyPress={(e) => handleKeyPressNumber(e)}/>
              <Controller name="fechaSueldo" render={({ field, fieldState: { error } }) => (
                <DatePicker {...field} label="Último Ajuste de Aueldo" disabled={disabled} inputFormat="dd/MM/yyyy" renderInput={(params) => (
                  <TextField fullWidth {...params} error={!!error} helperText={error?.message} />
                )}
                />
              )}
              ...
              <GenericCombo
                ...
                valorDefault={empresaValor}
              />
              <Controller name="finContrato" render={({ field, fieldState: { error } }) => (
                <DatePicker {...field} label="Fin de contrato" disabled={disabled} inputFormat="dd/MM/yyyy" renderInput={(params) => (
                  <TextField fullWidth {...params} error={!!error} helperText={error?.message} />
                )}
                />
              )}
      ...
      <Grid container spacing={3} sx={{ pb: 3 }}>
        <Grid item xs={12} md={12}>
          <Card sx={{ p: 3 }}>
            <Grid container direction='row' justifyContent='space-between'>
              <Grid item>
                <Typography variant='h5' color='primary' sx={{ pb: 3 }}>Contacto de emergencia</Typography>
              </Grid>
              <Grid item>
                {mostrarBotonEditar ?
                  null :
            ...
            >
              ...
              <RHFTextField disabled={disabled} type="text" name="nombreContacto" label="Nombre de contacto" onKeyPress={(e) => handleKeyPressLetter(e)}/>
              <GenericCombo
                endPointURL="https://localhost:7217/api/Empresa/ObtenerListaAreaPorEmpresas"
                nameAUX="parentesco"
                label="Parentesco"
              ...
              />
              <RHFTextField disabled={disabled} name="celularContacto" label="Celular" onKeyPress={(e) => handleKeyPressNumber(e)}/>
              <RHFTextField disabled={disabled} name="telefonoContacto" label="Teléfono Fijo" onKeyPress={(e) => handleKeyPressNumber(e)}/>
              <RHFTextField disabled={disabled} name="correoContacto" label="Correo Electrónico" />
